...
import 'package:finance_app/Screens/Registration%20Screen.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';

import '../Widgets/BottomNavigationBar1.dart';
                    ...
                    children: <Widget>[
                      ...
                      MaterialButton(
                        ...
                        onPressed: () {
                          ...
                          FirebaseHelper().login(useremail : email,password:password1).then((result){
                            if(result == null){
                      ...
                      TextButton(onPressed: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>const Registration()));
                          ...
                          child: const Text("Don't have an Account?! SignUp", style: TextStyle(
                            color: Colors.white,
                            fontSize: 18.0,
